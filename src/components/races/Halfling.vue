<template>
  <v-container>
    ...
    <v-card>
      <v-card-text>
        <blockquote>
          In the countryside, there are few as trustworthy as the halflings; in
          the cities, you can trust them too—so long as you've got coins to
          offer.
          <br />- Haven Thorne, trader
        </blockquote>
      </v-card-text>
      <v-img src="@/assets/halfling.png" max-width="400" />
      <v-card-title>
        Overview
      </v-card-title>
      <v-card-text>
        ...
        an oversized world or carve out their own small neighbourhoods, which
        are better equipped to accommodate their diminutive size.
      </v-card-text>
      <v-card-text>
        Unterlund is home to the vast majority of the halfling population,
        though they do live in the other nations of Balamyn; a few have even
        ventured so far as southern Ostramyn, but the cold does not suit their
        tastes, nor their proclivity for going about without shoes.
      </v-card-text>
      <v-card-title>
        Culture
      </v-card-title>
