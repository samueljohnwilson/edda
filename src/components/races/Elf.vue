<template>
  <v-container>
    ...
    <v-card>
      <v-card-text>
        <blockquote>
          "Upon the dying of the Sun and Moon,<br />Those trees and flowers yet
          to bloom,<br />Shall be the first to share the pain,<br />Of the elves
          that crossed from whence we came." <br />- Elvish proverb
        </blockquote>
      </v-card-text>
      <v-img src="@/assets/elf.webp" max-width="400" />
      <v-card-title>
        Overview
      </v-card-title>
      <v-card-text>
